...
exports.ee=function(username,password){
var subobject = [];
subobject["DDDDD"] = username;
subobject["R1"] = "0";
subobject["para"]="00";
subobject["0MKKey"]="123456";
subobject["v6ip"] = "";
if(username==""){console.log("请输入账号");return false;}
if(password==""){console.log("请输入密码");return false;}
if(ps==0){
  subobject["upass"]=xproc1(password);
}
else{
  tmpchar=pid+password+calg;
  subobject["upass"]=calcMD5(tmpchar)+calg+pid;
  subobject["R2"]="1";
}
return subobject;
}
...
function setFormFocus() {
  document.form1.DDDDD.focus(); 
  document.form1.DDDDD.select();
}
